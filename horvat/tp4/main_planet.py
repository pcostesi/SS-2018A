	...
	def get_info(self,i):
		...
		for planet in self.planets:
			if planet.name =="sun":
				...
				print "distance earth = " + str(hypot(planet.x - earth.x, planet.y - earth.y))
				print "distance mars = " + str(hypot(planet.x - mars.x, planet.y - mars.y))
